...
public abstract class Trace {
	 ...
	 *
	 * @param p   The origin of the new trace
	 * @param dir The direction of the new trace (normalized)
	...
	/**
	 * Computes the color resulting from a possible intersection with the scene. If
	 * a hit point could not be determined the background color of the scene is
	 * returned.
	 *
	 * @return The color resulting from a possible intersection with the scene. If a
	 *         hit point could not be determined the background color of the scene
	 *         is returned.
	 */
